...
def send_accounting_packet(username, ip_addr, auth_group='cc-netaccess', start=True, stop=False):
    srv = Client(server=SERVER, secret=SECRET.encode(), dict=Dictionary("src/dictionary"))
